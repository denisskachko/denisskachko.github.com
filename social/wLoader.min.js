(function(g, f, e) {
    var a;
    if (f.jQuery === e || f.jQuery.fn.jquery !== "1.9.1") {
        var c = document.createElement("script");
        c.setAttribute("type", "text/javascript");
        c.setAttribute("src", "http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js");
        if (c.readyState) {
    ...
    function b(h) {
        ...
        (function(s, r, i, q) {
            ...
            s.LoadScripts = function() {
                var u = [s.getResourceServerPath() + "/Scripts/widget/GlobalWidget.js", s.getResourceServerPath() + "/Scripts/widget/widgetController.js"];
                for (var t = u.length - 1; t >= 0; t--) {
                    k(u[t]);
                }
            };
            s.LoadCSS = function() {
                var t = [s.getResourceServerPath() + "/Content/widget.css"];
